...
const trainData = JSON.parse(fs.readFileSync("messages_train.json", "utf8"));
...
trainData.forEach(item => {
  ...
  map[k] = {
    ...
    amount: exp.amount !== undefined ? exp.amount : null,
...
fs.writeFileSync("src/parser/groundTruthTrie.ts", tsCode);
